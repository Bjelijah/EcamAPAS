...
//	{
//		return JniUtil.getWifi(ip);
//	}
	private native int setWifi(String ip,String ssid,String password);
//	{
//		return JniUtil.setWifi(ip, ssid, password);
//	}
	...
	Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case KEY_LESS_THEN_8:
				Toast.makeText(SettingActivity.this, "密码必须大于8位", Toast.LENGTH_LONG).show();
				break;
			case SET_SUCCESS:
				Toast.makeText(SettingActivity.this, "设置成功，重启设备生效", Toast.LENGTH_LONG).show();
				break;
			case SET_FAIL:
				Toast.makeText(SettingActivity.this, "设置失败，请重新设置", Toast.LENGTH_LONG).show();
				break;
			default:
				break;
			}
