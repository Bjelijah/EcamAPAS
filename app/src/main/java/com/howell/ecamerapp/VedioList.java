...
import com.howell.ecamerapp.downloadfile.AppFile;
import com.howell.ecamerapp.downloadfile.AppListAdapter;
import com.howell.ecamerapp.downloadfile.DownloadManager;
...
public class VedioList extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		vedioList.setonRefreshListener(new MyListViewWithFoot.OnRefreshListener() {
...
//	{
//		return JniUtil.getReplayList(file_list_handle, fileCount);
//	}
	public native void closeFileList(int file_list_handle);
//	{
//		JniUtil.closeFileList(file_list_handle);
//	}
...
//	{
//		return JniUtil.getListByPage(user_handle, slot, stream, replay, type, order_by_time, page_info);
//	}
	public native int vedioListLogin(String ip);
//	{
//		return JniUtil.vedioListLogin(ip);
//	}
	public native int vedioListLogout(int user_handle);
//	{
//		return JniUtil.vedioListLogout(user_handle);
//	}
